...
<div class="container">
	<div class="banner-info-wrapper">
		<div class="banner-info-title">
			<h1><?$APPLICATION->IncludeFile($APPLICATION->GetTemplatePath("/include/area/banket-title.php"),Array(),Array("MODE"=>"html"));?><br>
			 <?$APPLICATION->IncludeFile($APPLICATION->GetTemplatePath("/include/area/banket-title-span.php"),Array(),Array("MODE"=>"html"));?> </h1>
		</div>
...
<div class="container price-container">
	...
	Array(
		...
		"PARENT_SECTION_CODE" => "",
		"PREVIEW_TRUNCATE_LEN" => "",
		"PROPERTY_CODE" => array(0=>"DESCRIPTION",1=>"PRICE",2=>"",),
		"SEARCH_PAGE" => "/search/",
		"SET_BROWSER_TITLE" => "Y",
		"SET_LAST_MODIFIED" => "N",
		"SET_META_DESCRIPTION" => "Y",
...
<div class="container">
	...
	Array(
		...
		"PARENT_SECTION_CODE" => "",
		"PREVIEW_TRUNCATE_LEN" => "",
		"PROPERTY_CODE" => array(0=>"QUANTITY",1=>"DESCRIPTION",2=>"SQUARE",3=>"",),
		"SET_BROWSER_TITLE" => "Y",
		"SET_LAST_MODIFIED" => "N",
		"SET_META_DESCRIPTION" => "Y",
		"SET_META_KEYWORDS" => "Y",
...
<div class="container">
...
);?> <a href="https://kontinent26.ru/banqueting_hall/Банкетное меню.pdf" class="food-banket-download">банкетное меню (PDF)</a>
	<!--  -->
 ...
 </section> <section class="price-list">
<div class="container">
			...
			<div class="contacts-info-item">
				<div class="contacts-info-item-icon">
					<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
						<path fill-rule="evenodd" clip-rule="evenodd" d="M11.9969 2C7.59096 2 4 5.27438 4 9.29752C4 12.0326 7.71469 16.6332 10.2405 19.7613C10.9604 20.6529 11.5837 21.4249 11.9969 22C12.411 21.4238 13.0363 20.6498 13.7586 19.7559C16.2859 16.6278 20 12.031 20 9.29752C20 5.27438 16.409 2 11.9969 2ZM14 10C14 11.1046 13.1046 12 12 12C10.8954 12 10 11.1046 10 10C10 8.89543 10.8954 8 12 8C13.1046 8 14 8.89543 14 10Z" fill="#C7A462"/>
					</svg>
				</div>
				<p>
			...
			<div class="contacts-info-item">
				...
				<div class="contacts-info-item-text">
					<p>
					 ...
					 Вс - Чт: 12:00-00:00 Пт - Сб: 12:00 - 02:00 <a href="tel:+79624415416">+7 (962) 441 54 16</a>
				</div>
			</div>
			<div class="contacts-info-item">
				<div class="contacts-info-item-icon">
					<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
						<path fill-rule="evenodd" clip-rule="evenodd" d="M12.0217 2L14.9284 8.53531L22 9.27107L16.7072 14.0319L18.1822 21L12.0217 17.451L5.81779 21L7.29284 14.0319L2 9.27107L9.11497 8.53531L12.0217 2Z" fill="#C7A462"/>
					</svg>
				</div>
