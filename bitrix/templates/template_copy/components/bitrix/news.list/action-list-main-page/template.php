	...
	<?foreach($arResult["ITEMS"] as $arItem):?>
		...
		<div class="action-item" id="<?=$this->GetEditAreaId($arItem['ID']);?>">
			<div class="action-item-pic">
				<?$file = CFile::ResizeImageGet($arItem['PREVIEW_PICTURE'], array('width'=>365, 'height'=>222), BX_RESIZE_IMAGE_EXACT, true);?>
				<?/*<a href="<?=$arItem["DETAIL_PAGE_URL"]?>"><img src="<?=$file["src"]?>"></a>*/?>
				<a href="/specials/"><img src="<?=$file["src"]?>"></a>
			...
			<div class="action-item-text">
				<?/*<div class="action-item-name"><a href="<?=$arItem["DETAIL_PAGE_URL"]?>"><?=$arItem["NAME"]?></a></div>*/?>
				<div class="action-item-name"><a href="/specials/"><?=$arItem["NAME"]?></a></div>
