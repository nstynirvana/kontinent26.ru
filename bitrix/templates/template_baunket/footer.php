<?if(!defined("B_PROLOG_INCLUDED") || B_PROLOG_INCLUDED!==true) die();?>
        ...
        <div class="container">
            <nav class="header-navigation">
                <div class="cange-language">
                    <!-- <a href="" class="cange-language-btn">RU</a>
                    <div class="cange-language-delimiter"></div>
                    <a href="" class="cange-language-btn">EN</a> -->
                </div>
    ...
    <script src="/banqueting_hall/design/js/script.js"></script>
</body>
</html>
