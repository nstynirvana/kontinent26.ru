			...
			<div class="detail-page-text-content">
				<div class="detail-page-text-content-left">
					...
					<div class="detail-page-text-item item-zaezd">
						...
						<div class="detail-page-text-item-list">
							...
							<p><b>Ранний заезд</b> - заезд ранее указанного срока возможен при наличии свободных номеров, при гарантированном заезде оплата за сутки до даты заезда.</p>
						</div>
					</div>
					<div class="detail-page-text-item item-annylirovanie">
						<div class="detail-page-text-item-title">Аннуляция бронирования</div>
						<div class="detail-page-text-item-list">
							<p>Сроки полной или частичной аннуляции без штрафных санкций при бронировании для индивидуальных клиентов: до 14:00 за 1 сутки до даты заезда.</p>
						</div>
					</div>
				</div>
				<div class="detail-page-text-content-right">
					<div class="detail-page-text-item item-dopmesta">
						...
						<div class="detail-page-text-item-list">
							Стоимость дополнительного места составляет 1700 рублей. В стоимость дополнительного места включено: завтрак – «Шведский стол»
						</div>
					</div>
					<div class="detail-page-text-item item-deti">
						...
						<div class="detail-page-text-item-list">
							<p><b>До 5 лет</b> при условии проживания с родителями (родителем) в номере, бесплатно, включая завтрак «Шведский стол», без предоставления дополнительного места.</p>
<p><b>От 6 до 12 лет</b> при условии проживания с родителями (родителем) в номере, доплата составляет 1700 рублей от стоимости номера, предоставляется дополнительное место. Доплата включает: проживание, завтрак «Шведский стол».</p>			</div>
					</div>
					<div class="detail-page-text-item item-lgotniki">
						...
						<div class="detail-page-text-item-list">
							<p></p><p>Специальные условия для размещения льготной категории граждан РФ в соответствии с законодательством:</p>
							<p>Предоставляется скидка 50% на проживание при предъявлении документа, удостоверяющего право на получение льгот.</p><p></p>
						</div>
					</div>
				</div>
			</div>
